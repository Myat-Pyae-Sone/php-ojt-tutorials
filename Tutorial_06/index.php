        ...
        <form action="upload.php" class="px-3 py-3" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="text" class="form-control
              ...
              value="<?php echo !empty($_SESSION['folderName']) ? $_SESSION['folderName'] : ""; ?>" name="folder"
...
foreach ($files as $file) {
    ...
    echo "
    <div class='card m-auto w-25 d-flex flex-column me-2 ms-5 mt-3'>
    <img src='$file' class='w-100 mt-3 '>
    <p class='text-center mb-0 fs-4'>$folder</p><br>
    <p class='ms-2 mt-0 w-100'><a href='$file' class=' mt-0 '>localhost/php-ojt-tutorials/Tutorial_06/$file</a></p>

    <form method='post' class='w-100'>
    <input type='hidden' name='file_path' value='$file'>
    <input type='submit' class='w-100 p-2 text-dark btn btn-danger border-0 mb-2' name='delete' value='delete'>
    </form>
    </div>";
}
