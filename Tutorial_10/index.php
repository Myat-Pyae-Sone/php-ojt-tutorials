...
<body>
    ...
    ?>
        <div class="navbar navbar-light bg-light">
            <?php
            if ($row > 0) {
                $users = mysqli_fetch_assoc($query); //fetch all data from query
            ?>
                <div class="container-fluid w-75">
                    ...
                    <div class="float-end">
                        ...
                        if ($users['image'] == '') {
                            ...
                            echo "<img src='images/" . $users['image'] . "' class='user-img rounded-circle'  alt='img'>";
                        }
                        ?>
                    </div>
                </div>
        ...
        <div class="userImg float-end w-25">
            <form action="index.php" method="post" class="border border-secondary rounded p-2 w-50">
                ...
                <a href="index.php?email=<?php echo $uEmail; ?>" class="text-decoration-none text-dark" name="logout">Logout</a>
            </form>
        </div>
