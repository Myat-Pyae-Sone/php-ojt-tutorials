  ...
  <div class="card col-4 offset-4 mt-5 mb-3">
    ...
    <div class="card-body">
      <form action="generate.php" method="POST" class="form-group p-3 needs-validation" novalidate
        ...
        <input type="text" class="form-control  <?php echo (isset($_SESSION['errorMessage'])) ? 'is-invalid' : ""; ?>"
...
for ($i = 0; $i < count($folder); $i++) {
    if ($folder[$i] != '.' && $folder[$i] != '..') {
        ...
        echo "<div class='col-sm-4 '>
                <div class='card m-4'>
                <p class='text-center'><img src='$folder_dir$folder[$i]' alt='Image' class='w-75 '></p>
                <p class='text-center mb-0 pb-3'>$folder[$i]</p>
                </div>
              </div>";
    }
}
